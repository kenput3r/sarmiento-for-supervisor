...
export default function RequestYardSign() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      form.reset()
      setSubmitMessage('Thanks! Your yard sign request was submitted.')
    } catch (error) {
      setSubmitMessage('Sorry, there was an error submitting your request.')
    } finally {
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name='description'
          content='Get a yard sign to show your support for Vicente Sarmiento in his campaign for Orange County Supervisor'
        />
        <meta
          property='og:image'
        ...
        <meta
          name='og:title'
          content='Get A Yard Sign | Sarmiento For Orange County Supervisor'
        />
          ...
          <div className='md:col-span-2'>
            <div className='px-4 sm:px-0'>
              <h1 className='text-xl font-bold leading-6 text-gray-900'>
                {pageText.h1[language]}
              </h1>
              <p className='mt-1 text-sm text-gray-600'>
                {pageText.h2[language]}
              </p>
            </div>
          </div>
