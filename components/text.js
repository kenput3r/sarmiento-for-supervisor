...
export const pressReleaseText = {
  h1: {
    english: 'SANTA ANA MAYOR VICENTE SARMIENTO ANNOUNCES CANDIDACY FOR ORANGE COUNTY SUPERVISOR',
    spanish: 'EL ALCALDE DE SANTA ANA VICENTE SARMIENTO ANUNCIA CANDIDATURA PARA SUPERVISOR DEL CONDADO DE ORANGE',
  },
  h2: {
    english: 'Mayor Announces Intention To Run For Newly Created Open District 2 Supervisorial Seat That Is Over 62% Latino, Has A 25.6% Democratic Registration Advantage, & Of Which His City Of Santa Ana Makes Up Over 50% Of The District’s Population',
    spanish: 'El Alcalde se postulará para Supervisor del Condado de Orange - Distrito 2 que recién fue creado y cuál tiene más del 62 % de latinos, una ventaja de 25.6% registro demócrata , y donde la ciudad de Santa Ana representa más del 50% de la población del nuevo distrito',
  },
  paragraphs: [
    {
      english: 'SANTA ANA, CA – Santa Ana Mayor Vicente Sarmiento formally announced today he will be a candidate this June for the newly created open District 2 seat on the Orange County Board of Supervisors.  The new Central Orange County district is over 62% Latino, has a strong Democratic voter registration advantage of 25.6%, and contains the entire city of Santa Ana -- which as the only city entirely contained in the 2nd Supervisorial District, makes up over 50% of its population.',
      spanish: 'SANTA ANA, CA – El Alcalde de Santa Ana, Vicente Sarmiento, anunció formalmente que será  candidato en junio para el puesto vacante del Distrito 2 recientemente creado por la Mesa de  Supervisores del Condado de Orange. El nuevo distrito en el Centro del Condado de Orange tiene  más del 62% de latinos, tiene una fuerte ventaja de 25.6% en el registro de votantes demócratas y  contiene toda la ciudad de Santa Ana – está siendo la única ciudad que se encuentra en su  totalidad en el 2.º Distrito,, y constituye más de 50 % de la población.',
    },
    {
      english: '“Our Central Orange County community needs an advocate and a champion,” said Mayor Vicente Sarmiento.  “It’s time.”',
      spanish: '“Nuestra comunidad del Centro del Condado de Orange necesita un defensor y un campeón”, dijo el  Alcalde Vicente Sarmiento. "Ya es tiempo"',
    },
    {
      ...
      spanish: '“He trabajado duro en Santa Ana para reducir la crisis de personas sin hogar, mejorar la atención y  recursos de la salud publica – incluyendo la contención de COVID-19, aumentar la cantidad de  parques y espacios abiertos que tanto se necesitan, responder a las crecientes necesidades de las  familias trabajadoras en nuestra comunidad, y trabajar para aumentar la transparencia en el  gobierno. Ahora espero expander mis esfuerzos en estos temas al nivel del condado, donde sé que  juntos marcaremos la diferencia”.',
    },
    {
      english: 'Sarmiento has over 14 years of experience on the Santa Ana City Council.  He was first appointed in January 2007 and was subsequently re-elected in 2008, 2012, and 2016.  In 2020 he was elected as only the second Latino Mayor in Santa Ana’s 152-year history.',
      spanish: 'El Alcalde Sarmiento tiene más de 14 años de experiencia en el Consejo Municipal de Santa Ana.  Fue nombrado por primera vez en enero de 2007 y reelegido en 2008, 2012 y 2016. En 2020 fue  elegido como el segundo alcalde latino en los 152 años de la historia de Santa Ana.',
    },
    {
      english: 'As Supervisor, Sarmiento would be only the 3rd Latino Supervisor in County History – and the first Santa Ana official to serve on the Orange County Board of Supervisors in 74 years.',
      spanish: 'Como Supervisor, el Alcalde Sarmiento sería solo el tercer Supervisor latino en la historia del  condado y el primer funcionario de Santa Ana en servir en la Mesa Directiva de Supervisores del  Condado de Orange en 74 años.',
    },
    {
      english: 'Mayor Sarmiento currently serves as a Member of the Orange County Transportation Authority (OCTA) Board of Directors and served as President and a Member of the Orange County Water District Board of Directors for 6 years.',
      spanish: 'El Alcalde Sarmiento actualmente es Miembro de la Mesa Directiva de la Autoridad de Transporte del Condado de Orange (OCTA) y se desempeñó como Presidente y Miembro de la Mesa Directiva  del Distrito de Agua del Condado de Orange durante 6 años.',
    },
    {
      english: 'Raised in Santa Ana and Central Orange County, Sarmiento attended local public schools, graduated from the University of California, Berkeley with a Bachelor of Arts in Economics, and earned his Law Degree from the University of California, Los Angeles.  He proudly returned home to Santa Ana with his wife Eva to raise their family, start his own Santa Ana-based Financial Law practice, and enter public service to assist his hometown of Santa Ana become the thriving and vibrant city it is today.',
      spanish: 'Criado en Santa Ana y en el centro del Condado de Orange, el Alcalde Sarmiento estudio en las  escuelas públicas locales, se graduó de la Universidad de California, Berkeley con una licenciatura  en economía y obtuvo su título de abogado en la Universidad de California, Los Ángeles. Regresó  con orgullo a su hogar en Santa Ana con su esposa Eva para criar a su familia, abrir su propio  despacho de derecho finánciales en Santa Ana e ingresar al servicio público para ayudar a su  ciudad natal de Santa Ana a convertirse en la ciudad próspera y vibrante que es hoy.',
    },
  ],
}
