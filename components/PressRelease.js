...
import campaignLogo from '../images/for-supervisor-primary_blue.png'
...
function PressRelease() {
  ...
  return (
    <div className='w-[1024px] max-w-full mx-auto px-4 pb-8 my-8 border-b phones:px-1'>
      ...
      <div className='mb-8'>
        <p>
          <span className='font-bold'>FOR IMMEDIATE RELEASE:</span> November 29,
          2022
        </p>

        <p>
          <span className='font-bold'>CONTACT:</span> Carlos Valenzuela,{' '}
          <a
